...
import com.freshness.ads.databinding.LoadingLayoutNativeAdHomeCompactBinding
import com.google.android.libraries.ads.mobile.sdk.nativead.NativeAd

/** Container shimmer + [NativeAdHomeCompactView] cho placement native ở Home. */
class LoadingNativeAdHomeCompactView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : BaseLoadingNativeAdView(context, attrs) {

    private val viewBinding =
        LoadingLayoutNativeAdHomeCompactBinding.inflate(LayoutInflater.from(context), this, true)
