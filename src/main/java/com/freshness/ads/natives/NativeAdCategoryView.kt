...
import com.freshness.ads.databinding.LayoutNativeAdCategoryBinding
import com.google.android.libraries.ads.mobile.sdk.nativead.MediaView
import com.google.android.libraries.ads.mobile.sdk.nativead.NativeAdView

class NativeAdCategoryView(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private val viewBinding =
        LayoutNativeAdCategoryBinding.inflate(LayoutInflater.from(context), this, true)
