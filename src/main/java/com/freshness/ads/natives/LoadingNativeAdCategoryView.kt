...
import com.freshness.ads.databinding.LoadingLayoutNativeAdCategoryBinding
import com.google.android.libraries.ads.mobile.sdk.nativead.NativeAd

class LoadingNativeAdCategoryView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : BaseLoadingNativeAdView(context, attrs) {

    private val viewBinding =
        LoadingLayoutNativeAdCategoryBinding.inflate(LayoutInflater.from(context), this, true)
