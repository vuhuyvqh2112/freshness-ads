...
import com.freshness.ads.databinding.LoadingNativeCtaBottomViewBinding

class LoadingNativeCtaBottomView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : BaseLoadingNativeAdView(context, attrs) {

    private val viewBinding =
        LoadingNativeCtaBottomViewBinding.inflate(LayoutInflater.from(context), this, true)
