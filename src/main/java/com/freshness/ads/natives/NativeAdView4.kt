...
import com.freshness.ads.databinding.LayoutNativeAdView4Binding

class NativeAdView4(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private val viewBinding = LayoutNativeAdView4Binding.inflate(LayoutInflater.from(context), this, true)
