...
import com.freshness.ads.databinding.LayoutNativeAdView3Binding

class NativeAdView3(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private val viewBinding = LayoutNativeAdView3Binding.inflate(LayoutInflater.from(context), this, true)
