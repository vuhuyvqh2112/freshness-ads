...
import com.freshness.ads.databinding.LayoutNativeAdListViewBinding
import com.google.android.libraries.ads.mobile.sdk.nativead.MediaView
import com.google.android.libraries.ads.mobile.sdk.nativead.NativeAdView
import com.freshness.ads.databinding.LayoutNativeAdView1Binding

class NativeAdListView(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private val viewBinding = LayoutNativeAdListViewBinding.inflate(LayoutInflater.from(context), this, true)
