...
import com.freshness.ads.databinding.LoadingLayoutNativeAdView2Binding

class LoadingNativeAdView2 @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : BaseLoadingNativeAdView(context, attrs) {

    private val viewBinding =
        LoadingLayoutNativeAdView2Binding.inflate(LayoutInflater.from(context), this, true)
