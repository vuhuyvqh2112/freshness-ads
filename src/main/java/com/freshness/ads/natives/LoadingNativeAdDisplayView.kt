...
import com.freshness.ads.databinding.LoadingLayoutNativeAdDisplayBinding
import com.google.android.libraries.ads.mobile.sdk.nativead.NativeAd

class LoadingNativeAdDisplayView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : BaseLoadingNativeAdView(context, attrs) {

    private val viewBinding =
        LoadingLayoutNativeAdDisplayBinding.inflate(LayoutInflater.from(context), this, true)
