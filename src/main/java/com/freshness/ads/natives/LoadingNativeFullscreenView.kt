...
import com.freshness.ads.databinding.LoadingNativeFullscreenViewBinding

class LoadingNativeFullscreenView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : BaseLoadingNativeAdView(context, attrs) {

    private val viewBinding =
        LoadingNativeFullscreenViewBinding.inflate(LayoutInflater.from(context), this, true)
