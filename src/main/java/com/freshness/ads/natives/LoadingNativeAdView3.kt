...
import com.freshness.ads.databinding.LoadingLayoutNativeAdView3Binding

class LoadingNativeAdView3 @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : BaseLoadingNativeAdView(context, attrs) {

    private val viewBinding =
        LoadingLayoutNativeAdView3Binding.inflate(LayoutInflater.from(context), this, true)
