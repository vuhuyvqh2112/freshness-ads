...
import com.freshness.ads.databinding.LayoutNativeAdView2Binding

class NativeAdView2(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private val viewBinding = LayoutNativeAdView2Binding.inflate(LayoutInflater.from(context), this, true)
