...
import com.freshness.ads.databinding.NativeCtaBottomViewBinding
import com.freshness.ads.databinding.NativeFullscreenViewBinding

class NativeFullscreenView(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private val viewBinding =
        NativeFullscreenViewBinding.inflate(LayoutInflater.from(context), this, true)
